...
//$con=mysqli_connect("localhost","safau1","Jkhouse115@4782","safad1");
...
if(isset($_REQUEST["submitmarks"]))
{
 ...
 function AdminCode()
  {
      $con=mysqli_connect("localhost","id17480276_safau1","Jkhouse115@4782","id17480276_safad1");
...
?>
      <form id="admin" action="admin.php" method="post">
            <div class="container-fluid">    
                <div class="row">
                  <div class="col-sm-12">
                        <img src="images/header.png" width="100%" style="box-shadow: 0px 5px 5px #999999; "></img>
                  </div>
                 </div>    
             </div>
