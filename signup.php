    ...
    <body style="background-image:url('./images/inbg.jpg');">
        <form id="signup" action="signupconfirm.php" method="post">
            ...
            <div class="container-fluid">    
                <div class="row">
                  <div class="col-sm-12">
                       <center> <img src="images/cpi-logo.png" width="80%" style="box-shadow: 1px 5px 14px #999999; "></img> </center>
                  </div>
                 </div>    
             </div>
        <div id="dmid">
        ...
        <div id="ddown">
            ...
            <img src="images/signup1.jpg" style="height:470px;width:550px;border-top-left-radius:15px;border-bottom-left-radius:15px;" ></img>
             ...
             <div id="drig">
                 <br>
            <font style="color:black; margin-left:30px; font-size:22px; font-family: calibri;font-weight: bold;">Registration Here</font>
                    <table id="tabintro">
                <tr>
                    <td>
                        <font style="color:black; margin-left:30px; font-family: calibri;  margin-top:15px; font-size:17px;">Name * </font>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>
                        <font style="color:black; margin-left:30px; font-family: calibri;font-size:17px;">Date of Birth * <font>
                    </td>
                </tr>
                <tr>
                    <td  style="padding-bottom: 1em;">
                 ...
                 <tr>
                    <td>
                       <font style="color:black; margin-left:30px; font-family: calibri;font-size:17px;" required> Email Address <font>
                    </td>
                 </tr>
                 <tr>
                    <td  style="padding-bottom: 1em;">
                ...
                <tr>
                    <td>
                       <font style="color:black; margin-left:30px; font-family: calibri;font-size:17px;" required> Mobile No. *<font>
                    </td>
                 </tr>
                 <tr>
                    <td  style="padding-bottom: 1em;">
                ...
                <tr>
                    <td> 
                           ...
                           <input type="submit" id="in_sub" name="in_sub" onclick="validate();"  value="Registration"  style="margin-top: 8px;margin-left:90px;" class="toggle btn btn-primary">
