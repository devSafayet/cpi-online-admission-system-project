...
$con=mysqli_connect("localhost","root","","cpiadmission2");
//$con=mysqli_connect("localhost","onlinead_oas","Sk143743@","onlinead_oas");
...
<html>
    ...
    <body>
      ...
      <center>  <table class="table table-bordered" style="font-family: Verdana">
                ...
                <tr>
                 <td style="width:3%;"><br><br><img src="./images/aub.png" width="50%"> </td>
                 <td style="width:8%;"><center><font style="font-family:Arial Black; font-size:20px;">
                     <br><br>
                    Asian University of Bangladesh (AUB) </font>
					<br> House 25, Road 5, Sector 7
Uttara Model Town, Dhaka-1230.
					</center>
                
                <center><font style="font-family:Verdana; font-size:18px;">
                    Tel: +880-2-48950729(Ext.101), +880-2-58950709(Ext.102) 
                    </font> <br> E-mail: info@aub.edu.bd </center>
